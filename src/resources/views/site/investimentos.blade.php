...
@section('nav')
    ...
    <li class="nav-item">
        <a class="nav-link mr-2 ml-4 active" href="{{ route('investimentos')  }}">Investimentos</a>
    </li>
@endsection

@section('titulo')
    <h1>Manipular investimentos:</h1>
@endsection

@section('dadosDaConta')
    <section class="mb-4">
        <h3 class="pt-3 ml-4">Dados da conta:</h3>
        <form class="pt-2 px-5" action="{{ route('updateInvestimentos') }}" method="post">
            @csrf
            @method('put')
            <div class="form-group">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo" id="investir" value="investir" checked>
                        <label class="form-check-label" for="investir">
                            Investir
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="tipo" id="resgatar" value="resgatar">
                        <label class="form-check-label btn-dank" for="resgatar">
                            Resgatar
                        </label>
                    </div>
                </div>
